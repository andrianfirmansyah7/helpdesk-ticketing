      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body">
			<form action="<?php echo base_url()?>home/input_user" method="post">
              <div class="box-body">
                <div class="form-group">
                  <label for="nik">ID User</label>
				...
				<div class="form-group">
                  <label for="Jenis Kelamin">Perusahaan/Instansi</label>
				  <input type="text" class="form-control" id="lengkap" name="perusahaan" placeholder="Perusahaan">
                </div>
				<div class="form-group">
                  <label for="aplikasi">Jenis Aplikasi</label>
				  <select class="form-control" id="lengkap" name="aplikasi">
	                <option value="" disabled selected>Aplikasi</option>
                    <option value="B'Cloth">B'Cloth</option>
                    <option value="B'Mart">B'Mart</option>
                    <option value="B'Resto">B'Resto</option>
